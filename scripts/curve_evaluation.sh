...
#               choices: baseline vanilla position_embedding coordinate polar rotation rotation_relative
...
VALID_METHODS="baseline vanilla position_embedding coordinate polar rotation rotation_relative"

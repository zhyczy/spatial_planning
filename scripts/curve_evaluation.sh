...
#               choices: baseline vanilla position_embedding coordinate polar rotation rotation_relative rotation_rl
...
VALID_METHODS="baseline vanilla position_embedding coordinate polar rotation rotation_relative rotation_rl"

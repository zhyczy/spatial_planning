...
#   bash scripts/run_evaluation.sh qwen3-vl checkpoints/Qwen3.5-4B
#   bash scripts/run_evaluation.sh qwen3-vl checkpoints/Qwen3.5-4B generated_images/mmsibench/Qwen3.5-4B/flux2-klein-4B
#   bash scripts/run_evaluation.sh qwen3-vl checkpoints/Qwen3.5-4B generated_images/mmsibench/Qwen3.5-4B/flux2-klein-4B --limit 12
#
#   # Restrict to specific GPUs
#   CUDA_VISIBLE_DEVICES=0,1 bash scripts/run_evaluation.sh qwen3-vl checkpoints/Qwen3.5-4B
